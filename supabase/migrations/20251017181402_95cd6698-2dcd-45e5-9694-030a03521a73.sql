-- Update the handle_new_user_profile function to change admin email to security.admin@oberaconnect.com
...
DECLARE
  user_full_name text;
  admin_role_id uuid;
  admin_emails text[] := ARRAY['admin@admin.com', 'jerm712@icloud.com', 'security.admin@oberaconnect.com'];
  safe_email text;
BEGIN
  ...
  -- Optional admin role assignment for whitelisted emails (now includes security.admin@oberaconnect.com)
