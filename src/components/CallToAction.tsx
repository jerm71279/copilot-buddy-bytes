      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Ready to Unlock ML-Powered Intelligence?
          </h2>
          <p className="text-xl text-white/90 mb-12 max-w-2xl mx-auto">
            Join OberaConnect and 500+ enterprises using machine learning to predict problems, optimize operations, 
            and solve business challenges. The more systems you connect, the smarter your operations become.
          </p>
